...
int getKey(int q0, int q1, int q2, int q3, int type) {
  ...
  case MEM_TYPE_2:
    return ((indexRasterX[q2] * numRasterY) +
            indexRasterY[q3]);
    
  case MEM_TYPE_1:
    return ((indexRasterY[q1]) * numRasterX +
            indexRasterX[q2]) * numRasterY
      + indexRasterY[q3];
 ...
 * Return the index associated to the L-shaped piece (q0, q1, q2, q3).
 */
int LIndex(int q0, int q1, int q2, int q3, int type) {

  switch(type) {
  case  MEM_TYPE_4:
    return (((indexRasterX[q0] * numRasterY) +
             indexRasterY[q1]) * numRasterX +
            indexRasterX[q2]) * numRasterY
      + indexRasterY[q3];
