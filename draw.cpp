 ...
 * Contact information:
 *
 * Rafael Durbano Lobato <rafael@lobato.it>
 * http://lobato.it/
 */
...
inline int LIndex(int q0, int q1, int q2, int q3) {
 ...
 */
void normalizeDegeneratedL(int *q) {
  if(q[2] == 0) {
    q[2] = q[0];
    q[1] = q[3];
  }
...
void P1(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P2(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P3(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P4(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P5(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P6(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P7(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void P8(int start, int end, int L, int *q, int deltaX, int deltaY) {
...
void drawR(int L, int *q) {
  ...
  case B8:  drawB8(L, q); break;
  case B9:  drawB9(L, q); break;
  default:
    break;
  }
}
...
void MakeFile(int Lo, int Wo, int L, int *q, int n){
  FILE *file;
  ...
  for(int i = 0; i < n; i++) {
    fprintf(file, "%d %d %d %d\n",
            ptoRet[i][0], ptoRet[i][1], ptoRet[i][2], ptoRet[i][3]);
  }
...
void draw(int Lo, int Wo, int L, int *q, int n, bool solvedWithL) {
